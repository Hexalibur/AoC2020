...
5-6 d: jdddqqt";
        ...
        public static readonly string d3_list = @"...#....#.#...##......#.#...##.
.#..#...##..#....##........##..
..##.##...##.#.#....#..#......#
....#....#..#..#.#....#..###...
####.....##.#.##...##..#....#..
...
#.#.#..#..#.#..#...###.#.#....#";
        ...
        public static readonly string d4_list = @"eyr:2027
hcl:#602927
...
ecl:oth hcl:#602927 eyr:2025 iyr:2013 hgt:151cm byr:1992 pid:812583062";
        ...
        public static readonly string d5_list = @"FBFBBBFRLR
FBBFBBBLLR
FFFFFBBRRL
BBBFFFBRRL
BFFBFBFLRL
...
FFBFBFFLRL";
        ...
        public static readonly string d6_list = @"cady
ipldcyf
xybgcd
gcdy
dygbc
...
nzhlj";
        ...
        public static readonly string d7_list = @"bright indigo bags contain 4 shiny turquoise bags, 3 wavy yellow bags.
...
wavy crimson bags contain 2 dull fuchsia bags, 5 striped tomato bags.";
        ...
        public static readonly string d8_list = @"acc +45
nop +631
acc +12
acc -10
jmp +127
...
jmp +1";
        ...
        public static readonly string d9_list = @"50
32
17
18
6
...
60251067993757";
        ...
        public static readonly string d10_list = @"56
139
42
28
3
...
140";
        ...
        public static readonly string d11_list = @"LLLLLLLL.LLLLLLLLLLLLL.LLLLL.LLLLLLLL.LLLLLLLLLLLLLLLL.LLLL..LLLLLLL..LLLLLL.LLLLLLLL.L.LLLLLLLLLLL
...
LLL.LLLLLLLLLLLL.LLLLL.LLL.LLLLLLLLLLLLLLLLLLLLLLL.LLL.LLLLL.LLLLLLL.LLLLLLL.LLLL.LLL.LLLLLL.LLLLLL";
        ...
        public static readonly string d12_list = @"N1
R90
S5
R180
N3
...
F26";
        ...
        public static readonly string d13_list = @"1006401
17,x,x,x,x,x,x,x,x,x,x,37,x,x,x,x,x,449,x,x,x,x,x,x,x,23,x,x,x,x,13,x,x,x,x,x,19,x,x,x,x,x,x,x,x,x,x,x,607,x,x,x,x,x,x,x,x,x,41,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,29";
        ...
        public static readonly string d14_list = @"mask = 00000X110010111111X000100XX01010000X
mem[20690] = 435
mem[54036] = 231
mem[27099] = 118644255
mem[55683] = 22299263
...
mem[21482] = 161753";
        ...
        public static readonly string d16_list = @"departure location: 41-525 or 538-968
...
463,173,86,198,987,51,549,567,737,690,170,340,188,496,319,598,600,61,214,203";
        ...
        public static readonly string d17_list = @"..##.#.#
.#####..
#.....##
##.##.#.
..#...#.
...
#..##.##";
        ...
        public static readonly string d18_list = @"(8 * 4 + 6 + (7 + 3 * 9 + 4 * 3) + 2 + 2) * 3 * 8 * 2 * 9 * (5 * 5 * 2 * 6)
...
9 + 5 * (4 * 6 * 7 + 5 + 4 + 6) * (2 * 8 * 4 + 4 + (2 * 5 * 6) + (9 * 6 * 4 + 9)) + 4 + 6";
        ...
        public static readonly string d19_list = @"136: 83 66 | 102 116
120: 83 66 | 58 116
26: 56 116 | 105 66
42: 37 66 | 100 116
103: 116 33 | 66 47
...
abbabbabbaabbaaababbbabb";
        ...
        public static readonly string d20_list = @"Tile 3923:
...##.....
.##.#..#.#
###....#..
...#...#.#
...
brcnbqc qtsgr vdr rnkbccd bqsngs nchklb kgjm pbvf knfsd kvg trvv xhbzbt hvnkk zfhz zjxssr xrdtpr rpmczd rzxq hqqdr rvj nqvxt mhgxm qsjszn smpg cn brgkb jrtdg jjjs mmpmmh hlcxrd ntcpp sgnqbn cpxmpc ldbcvh vvjvph qmrps djsq cjlgz bsgvtrs rqsnq btf pzglb qnvx sgvk vvfjj sppx xdsxbrx cgnb rqksl bnv khrgj smlp cjjmhlmm cljf mqv pvqv hlqknsf qpdjgp pnzqt ctk thjh xtjfp bkgxfl rpk kcxrlp fkmj lptpdd ddbnz ksqp xsljt vtk tqv hgjjt tsvk hlfg qjgnp qjjss qjcktn ltxqk (contains shellfish, wheat)";
        ...
        public static readonly string d22_list = @"Player 1:
43
9
33
47
...
37";
        ...
        public static readonly string d23_list = @"362981754";
        public static readonly string d24_list = @"enwwsenweswweseseswnenewwswseswenw
...
newnwnwnwnwwnweswwewsewenwwnwnwnwnw";
        ...
        public static readonly string d25_list = @"14012298
74241";
    }
}
